...
# Windows
  ...
  - As usual, disable everything you don't explicitely need and avoid installing unnecessary, bloated drivers (included in e.g. Realtek audio, gaming peripheral software).
