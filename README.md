...
# Physical setup
  - Issues with [EMI](https://en.wikipedia.org/wiki/Electromagnetic_interference) and [electricity](https://en.wikipedia.org/wiki/Ground_loop_(electricity)) can cause unintended behavior of electronic components, potentially [increasing input lag](https://github.com/BoringBoredom/PC-Optimization-Hub/blob/main/content/emc_list.md#list-of-forum-threads-from-users-reporting-increased-input-lag-due-to-lack-of-electromagnetic-compatibility). Problems can occur due to [insufficient quality control](https://bit-tech.net/news/tech/motherboards_not_passing_emi_tests/1/) or [oversight regarding magnitude of impact from/on other independently manufactured components](https://www.theverge.com/circuitbreaker/2017/2/3/14496044/lg-ultrafine-5k-display-router-fix-redesign). Here are some [resources regarding electromagnetic compatibility](https://github.com/djdallmann/GamingPCSetup/blob/master/CONTENT/TECHNICAL%20REFERENCES/README.md#electrical).
